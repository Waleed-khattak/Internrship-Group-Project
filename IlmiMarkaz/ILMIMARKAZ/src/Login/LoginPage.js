...
export default function LoginPage() {
  ...
  const dummyUsers = [
    { email: "admin@example.com", password: "12345", role: 1 },
    { email: "teacher@example.com", password: "12345", role: 2 },
    { email: "student@example.com", password: "12345", role: 3 },
  ];
...
else if (user.role === 2) navigate("/teacher");
